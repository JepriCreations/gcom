...
export const Config = z
  .object({
    clean_console: z.boolean().default(false),
    check_status: z.boolean().default(true),
    commit_type: z
      .object({
        enable: z.boolean().default(true),
        initial_value: z.string().default('refactor'),
    ...
    check_ticket: z
      .object({
        infer_ticket: z.boolean().default(false),
    ...
    commit_title: z
      .object({
        max_size: z.number().positive().lte(72).default(50),
      })
      .default({}),
    commit_body: z
      .object({
